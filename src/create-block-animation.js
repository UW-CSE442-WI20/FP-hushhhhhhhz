...
class BlockAnimation {
	...
	start() {
		...
		text_container.append('div').attr('id', 'startAnimation').text("Start Animation")
		...
		decryptBubble
			.append('div')
			.attr("id", "block_decr_bubble")
			.append("h2")
			.text("Decryption")
			.append("br")
		
		d3.select("#block_decr_bubble")
			.append("div")
			.append("text")
			.attr("dy", "1em")
			.text("Decryption works the same way, just the opposite")
